                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <c:if test="${review.status.name == 'Public'}">
                                        <button onclick="hideReview('${review.id}')" class="w-full bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg transition-colors">
                                            <i class="fas fa-eye-slash mr-2"></i>Show Review
                                        </button>
                                    </c:if>
                                    <c:if test="${review.status.name == 'Hidden'}">
                                        <button onclick="deleteReview('${review.id}')" class="w-full bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-colors">
                                            <i class="fas fa-trash mr-2"></i>Hide Review
                                        </button>
                                    </c:if>
                                </div>
                            </div>
