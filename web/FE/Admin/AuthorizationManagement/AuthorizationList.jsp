<%-- 
    Document   : AuthorizationList
    Created on : Jul 16, 2025, 10:33:09 PM
    Author     : nongducdai
--%>
...
<!--                            <a href="${pageContext.request.contextPath}/manage/logs" 
            ...
            <main class="flex-1 px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 mb-8">
                    ...
                    <p class="text-gray-600">Manage and monitor all Endpoints in FUHF homestay booking system</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                        <!-- Filters -->
                        <form action="${pageContext.request.contextPath}/manage/authorization" method="GET">
                            <div class="flex items-center space-x-4">
                                ...
                                <button type="button" onclick="location.href = '${pageContext.request.contextPath}/manage/authorization'"
                                        class="bg-gray-100 text-gray-700 px-6 py-2 rounded-lg font-semibold hover:bg-gray-200 transition-colors duration-300">
                                    Clear Filter
                                </button>
                                <button type="button" onclick="location.href = '${pageContext.request.contextPath}/manage/authorization/add'"
