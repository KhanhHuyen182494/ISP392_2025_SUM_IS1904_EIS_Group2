<%-- 
    Document   : PaymentCancle
    Created on : Jul 2, 2025, 7:40:19 AM
    Author     : huyen
--%>
    ...
    <body class="bg-gray-50">
        ...
        <div class="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-center">
                    <div class="flex items-center w-full max-w-7xl">
                        ...
                        <!-- Step 4 - Cancelled -->
                        <div class="flex items-center flex-1">
                            <div class="w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center text-sm font-semibold">
                                <i class="fas fa-times"></i>
                            </div>
                            <div class="ml-2 text-sm font-medium text-red-600">Payment</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <!-- Left Side - Payment Cancelled -->
                <div class="lg:col-span-3">
                    <!-- Cancel Header -->
                    <div class="bg-gradient-to-r from-red-500 to-red-600 rounded-lg shadow-lg p-8 mb-6 text-white text-center">
                        <div class="mb-4">
                            <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
                                <i class="fas fa-times text-red-500 text-3xl"></i>
                            </div>
                            <h1 class="text-3xl font-bold mb-2">Payment Cancelled</h1>
                            <p class="text-red-100 text-lg">Your payment has been cancelled. No charges were made to your account.</p>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <span class="font-medium text-red-800">Your booking has not been confirmed</span>
                            </div>
                            <p class="text-red-700 text-sm">Since the payment was cancelled, your booking reservation is not active. The property remains available for booking.</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium">${booking.check_in != null ? booking.check_in : 'Not Reserved'}</span>
                                    </div>
                                    <div class="flex justify-between">
                            ...
                            <div>
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Date:</span>
                                        <span class="font-medium">${booking.checkout != null ? booking.checkout : 'Not Reserved'}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Time:</span>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <div class="font-medium text-blue-900">Try Payment Again</div>
                                    <div class="text-blue-700 text-sm">You can return to the booking and complete the payment process if you wish to secure your reservation</div>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    <div class="font-medium text-blue-900">Browse Other Properties</div>
                                    <div class="text-blue-700 text-sm">Explore other available homestays that might interest you</div>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    <div class="font-medium text-blue-900">Contact Support</div>
                                    <div class="text-blue-700 text-sm">If you experienced any issues during payment, our support team is here to help</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-lg p-6 sticky top-24 space-y-6">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Payment Cancelled</h3>
                            <p class="text-sm text-gray-600">No charges were made to your account</p>
                        </div>
                        ...
                        <div class="border-t pt-4 space-y-3">
                            ...
                            <button id="contactSupportBtn" class="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2">
        ...
        <script>
            ...
            document.getElementById('contactSupportBtn').addEventListener('click', function () {
                Swal.fire({
                    ...
                    html: `
                        <div class="text-left">
                            <p class="mb-3">You can reach our support team through:</p>
                            <div class="space-y-2">
                                <div class="flex items-center gap-2">
                                    <i class="fas fa-phone text-blue-500"></i>
                                    <span>+84 123 456 789</span>
