                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="content" name="content" 
                                              ...
                                              placeholder="Describe your homestay...">${p.content}</textarea>
                                </div>

                                <!-- Type -->
                                <div>
                                    <label for="postType" class="block text-lg font-semibold text-gray-700 mb-2">
                                ...
                                <c:if test="${p.post_type.id == 1}">
                                    <div>
                                        <label for="homestay" class="block text-lg font-semibold text-gray-700 mb-2">
                                            <i class="fas fa-building mr-2 text-blue-500"></i>
                                            Homestay Associate (homestay image will auto display on post!)
                                        </label>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="carousel-container mb-6" id="postCarousel">
