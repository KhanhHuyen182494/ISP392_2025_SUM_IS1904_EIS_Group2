 ...
 * @author Tam
 */
@WebServlet(name = "LoadMorePostProfile", urlPatterns = {"/loadmorepostprofile"})
public class LoadMorePostProfileController extends BaseAuthorization {

    private static final Logger LOGGER = Logger.getLogger(LoadMorePostProfileController.class.getName());
