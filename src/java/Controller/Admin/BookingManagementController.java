...
public class BookingManagementController extends BaseAuthorization {
    ...
    protected void doGetBookingList(HttpServletRequest request, HttpServletResponse response, User user) throws ServletException, IOException {
        ...
        if (roleId == 1) { //Admin
            ...
            List<Booking> bList = bookDao.getListBookingHomestayOwnerManage(user, LIMIT, offset, keyword, date, statusId);
            ...
            int totalCount = bookDao.getListBookingHomestayOwnerManage(user, Integer.MAX_VALUE, 0, null, null, null).size();
